                                        ...
                                        <td class="px-6 py-4.5 text-right">
                                            <div class="flex justify-end items-center gap-2">
                                                <a href="{{ route('laporan.edit', $report->id) }}" 
                                                    class="p-2 rounded-xl text-yellow-600 hover:bg-yellow-50 hover:text-yellow-700 transition border border-yellow-100/20"
                                                    title="Edit Konten Laporan">
                                                ...
                                                <a href="{{ route('laporan.export', $report->id) }}" 
                                                    class="p-2 rounded-xl text-green-650 hover:bg-green-50 hover:text-green-700 transition border border-green-100/20"
                                                ...
                                                <form action="{{ route('laporan.destroy', $report->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus laporan bulanan ini beserta seluruh isinya?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                                        class="p-2 rounded-xl text-red-500 hover:bg-red-50 hover:text-red-700 transition border border-red-100/20"
                                                        title="Hapus Laporan">
